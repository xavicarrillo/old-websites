...
$cfgServers[1]['user'] = 'mundodisea';                // MySQL user (only needed with basic auth)
$cfgServers[1]['password'] = 'athi3';                // MySQL password (only needed with basic auth)
$cfgServers[1]['only_db'] = 'mundodisea';                 // If set to a db-name, only this db is accessible
...
$cfgServers[1]['user'] = 'mundodisea';                // MySQL user (only needed with basic auth)
$cfgServers[1]['password'] = 'athi3';                // MySQL password (only needed with basic auth)
$cfgServers[1]['only_db'] = 'mundodisea_db';                 // If set to a db-name, only this db is accessible
$cfgServers[1]['verbose'] = '';                 // Verbose name for this host - leave blank to show the hostname
...
$cfgServers[1]['user'] = 'mundodisea';                // MySQL user (only needed with basic auth)
$cfgServers[1]['password'] = 'athi3';                // MySQL password (only needed with basic auth)
$cfgServers[1]['only_db'] = 'apunts';                 // If set to a db-name, only this db is accessible
$cfgServers[1]['verbose'] = '';                 // Verbose name for this host - leave blank to show the hostname
