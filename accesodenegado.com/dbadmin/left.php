<?php
/* $Id: left.php,v 1.90 2002/04/20 07:59:57 loic1 Exp $ */
...
if ($num_dbs > 1) {
    ...
    <div id="el<?php echo $j;?>Child" class="child" style="margin-bottom: 5px"<?php echo $on_mouse; ?>>
        ...
        <a class="tblItem" title="<?php echo $url_title; ?>" target="phpmain" href="tbl_properties.php?<?php echo $common_url_query; ?>&amp;table=<?php echo urlencode($table); ?>">
            ...
            if (!empty($db_start) && $db == $db_start) {
                ...
                for ($t = 0; $t < $num_tables; $t++) {
                    ...
                    if (PMA_USR_BROWSER_AGENT == 'IE') {
                        $table_list .= '          <span class="tblItem"><a class="tblItem" title="' . $url_title . '" target="phpmain" href="tbl_properties.php?' . $common_url_query . '&amp;table=' . urlencode($table) . '">' . $table . '</a></span></nobr><br />' . "\n";
                    } else {
                        $table_list .= '          <a class="tblItem" title="' . $url_title . '" target="phpmain" href="tbl_properties.php?' . $common_url_query . '&amp;table=' . urlencode($table) . '">' . $table . '</a></nobr><br />' . "\n";
                    }
                } // end for $t (tables list)
