...
$strCantLoadMySQL = 'δεν μπορεί να φορτωθεί η επέκταση MySQL,<br />παρακαλώ ελέγξτε την ρύθμιση της PHP.';
...
$strPmaUriError = 'Η εντολή <tt>$cfgPmaAbsoluteUri</tt> ΠΡΕΠΕΙ να οριστεί στο αρχείο προεπιλογών!';
$strPos1 = 'Αρχή';
