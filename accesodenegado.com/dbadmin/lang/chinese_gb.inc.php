<?php
/* $Id: chinese_gb.inc.php,v 1.108 2002/04/10 12:37:29 lem9 Exp $ */
...
$strDatabaseWildcard = '数据库 (允许使用万用字元):';
$strDatabases = '数据库';
...
$strNoFrames = 'phpMyAdmin 较为适合使用在支援<b>页框</b>的浏览器.';
$strNoIndex = '没有已定义的索引!';
...
$strPmaUriError = '必须设定 <tt>$cfgPmaAbsoluteUri</tt> 在设定档案内!';
$strPos1 = '开始';
$strPrevious = '前一个';
$strPrimary = '键名';
$strPrimaryKey = '主键';
