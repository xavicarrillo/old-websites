 ...
 */
$cfgPmaAbsoluteUri 	= 'http://www.accesodenegado.com/dbadmin';
...
$cfgServers[$i]['user']		= 'accesodenegadoco';     // MySQL user
$cfgServers[$i]['password'] 	= 'athi3';          // MySQL password (only needed
                                                // with 'config' auth_type)
$cfgServers[$i]['only_db'] 		= 'accesodenegadocom_db_db';          // If set to a db-name, only
